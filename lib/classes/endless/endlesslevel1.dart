...
void set() {
  moves = 5;
  v = levelheadendless("14", endlesslevel1(),light,mov: moves,);
  sat1 = 1;
  sat2 = 1;
  sat3 = 0;
  sat4 = 0;
...
class endlesslevel1 extends StatefulWidget {
  const endlesslevel1({Key? key}) : super(key: key);

  @override
  State<endlesslevel1> createState() => _endlesslevel1State();
}

class _endlesslevel1State extends State<endlesslevel1> {
  var buttons = [
