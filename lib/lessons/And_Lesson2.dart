...
class And_Lesson2 extends StatefulWidget {
  const And_Lesson2({Key? key}) : super(key: key);

  @override
  _And_Lesson2State createState() => _And_Lesson2State();
}

class _And_Lesson2State extends State<And_Lesson2> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("../../assets/images/lessons/and_quiz2.png",height: 300,width: 300,)
            ],)
        ],
      ),
    );
