...
class Nand_lesson1 extends StatefulWidget {
  const Nand_lesson1({Key? key}) : super(key: key);

  @override
  _Nand_lesson1State createState() => _Nand_lesson1State();
}

class _Nand_lesson1State extends State<Nand_lesson1> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("../../assets/images/lessons/nand_quiz1.png",height: 300,width: 300,)
            ],)
        ],
      ),
    );
