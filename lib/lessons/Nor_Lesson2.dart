...
class Nor_Lesson2 extends StatefulWidget {
  const Nor_Lesson2({Key? key}) : super(key: key);

  @override
  _Nor_Lesson2State createState() => _Nor_Lesson2State();
}

class _Nor_Lesson2State extends State<Nor_Lesson2> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("../../assets/images/lessons/nor_quiz2.png",height: 300,width: 300,)
            ],)
        ],
      ),
    );
