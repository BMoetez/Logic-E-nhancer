...
class Nor_Lesson1 extends StatefulWidget {
  const Nor_Lesson1({Key? key}) : super(key: key);

  @override
  _Nor_Lesson1State createState() => _Nor_Lesson1State();
}

class _Nor_Lesson1State extends State<Nor_Lesson1> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("../../assets/images/lessons/nor_quiz1.png",height: 300,width: 300,)
            ],)
        ],
      ),
    );
