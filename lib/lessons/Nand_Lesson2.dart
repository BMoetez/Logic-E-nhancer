...
class Nand_lesson2 extends StatefulWidget {
  const Nand_lesson2({Key? key}) : super(key: key);

  @override
  _Nand_lesson2State createState() => _Nand_lesson2State();
}

class _Nand_lesson2State extends State<Nand_lesson2> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("../../assets/images/lessons/nand_quiz2.png",height: 300,width: 300,)
            ],)
        ],
      ),
    );
