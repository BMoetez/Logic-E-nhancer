...
class Nand_Lesson3 extends StatefulWidget {
  const Nand_Lesson3({Key? key}) : super(key: key);

  @override
  _Nand_Lesson3State createState() => _Nand_Lesson3State();
}

class _Nand_Lesson3State extends State<Nand_Lesson3> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("../../assets/images/lessons/nand_quiz3.png",height: 300,width: 300,)
            ],)
        ],
      ),
    );
