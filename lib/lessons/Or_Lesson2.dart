...
class Or_Lesson2 extends StatefulWidget {
  const Or_Lesson2({Key? key}) : super(key: key);

  @override
  _Or_Lesson2State createState() => _Or_Lesson2State();
}

class _Or_Lesson2State extends State<Or_Lesson2> {
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Image.asset("../../assets/images/lessons/or_quiz2.png",height: 300,width: 300,)
            ],)
        ],
      ),
    );
